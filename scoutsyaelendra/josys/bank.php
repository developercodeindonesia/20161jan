...
//session_start();
 ...
 echo "<script>window.alert('Untuk mengakses modul anda harus login!');window.location=('../../index.php');</script>";
  ...
  switch($_GET['act'])
  {
    // Tampilkan bank
    default:
      echo "<h2 class='hLine'>Edit Bank</h2> ";
      echo "<input class=butt type=button value='Tambah Bank' 
            onclick=\"window.location.href='?module=bank&act=tambahbanner';\">
    ...
    $table = "mod_banner";
      ...
      while ($r=mysql_fetch_array($tampil)){
         echo "<tr>
				...
				<td width='30'>
					<a href=?module=bank&act=editbanner&id=$r[id_banner]><img src='images/add-icon.gif' title='edit' /></a> </td>
				<td width='30'>
					<a href='$aksi?module=bank&act=hapus&id=$r[id_banner]&namafile=$r[gambar]'><img src='images/hr.gif' title='hapus' /></a> 
				</td>
               </tr>";
        $no++;
      }
      ...
      echo "<form method=POST action='$aksi?module=bank&act=input' enctype='multipart/form-data'>";
      ...
      echo "<tr>
            ...
            <tr>
              ...
              <p><small>*Ukuran banner 220x93px. Format *.Jpeg/jpg, *.png, *.gif </small></p>
              <input class=butt type=submit name=submit value=Simpan>
              <a href=media.php?module=bank><input class=butt type=button value=Batal></a>  </td>
            </tr>";
	  ...
	  case "editbanner";
		...
		echo "<form method=POST enctype='multipart/form-data' action=$aksi?module=bank&act=update>
        ...
        echo "<tr>
				...
				<td class='right'><a href=media.php?module=bank><input class=butt type=button value=Kembali></a>  
                </td>
              </tr>
              </tbody></table></form>";
		break;
