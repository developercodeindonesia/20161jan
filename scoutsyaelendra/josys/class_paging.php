...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=bookspage-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk link halaman 1,2,3 
function navHalamannew($halaman_aktif, $jmlhalaman){
$link_halaman = "";
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=newbookspage-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk link halaman 1,2,3 
function navHalamanbest($halaman_aktif, $jmlhalaman){
$link_halaman = "";
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=bestbookspage-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk link halaman 1,2,3 
function navHalamanresensi($halaman_aktif, $jmlhalaman){
$link_halaman = "";
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=resensibookspage-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk link halaman 1,2,3 
function navHalamanblog($halaman_aktif, $jmlhalaman){
$link_halaman = "";
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  if ($i == $halaman_aktif){
  ...
  $link_halaman .= "<a href=blogpage-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
function navHalamanpasc($halaman_aktif, $jmlhalaman){
$link_halaman = "";
$s=$_GET['s'];
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=pasc-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
}
function navHalamanpdsc($halaman_aktif, $jmlhalaman){
$link_halaman = "";
$s=$_GET['s'];
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=pdsc-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
}
function navHalamantasc($halaman_aktif, $jmlhalaman){
$link_halaman = "";
$s=$_GET['s'];
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=tasc-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
}
function navHalamantdsc($halaman_aktif, $jmlhalaman){
$link_halaman = "";
$s=$_GET['s'];
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=tdsc-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
function navHalamandasc($halaman_aktif, $jmlhalaman){
$link_halaman = "";
$s=$_GET['s'];
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=dasc-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
function navHalamanddsc($halaman_aktif, $jmlhalaman){
$link_halaman = "";
$s=$_GET['s'];
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=ddsc-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
}
function navHalamanb($halaman_aktif, $jmlhalaman){
$link_halaman = "";
$s=$_GET['s'];
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=b-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
}
function navHalamancari($halaman_aktif, $jmlhalaman, $kata){
$link_halaman = "";
// Link halaman 1,2,3, ...
for ($i=1; $i<=$jmlhalaman; $i++){
  if ($i == $halaman_aktif){
  ...
  $link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=form_cari&halaman=$i&kata=$kata>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
