				...
				<div class="col-sm-9">
					<div class="blog-post-area">
						...
						$kaos = mysql_query("SELECT * FROM artikel WHERE aktif='YA' ORDER BY id_artikel DESC LIMIT $posisi,$batas");
						...
						<div class="single-blog-post">
							...
							<div class="imgkaos">
								<a href="cetak-murah-<?php echo $ka['id_artikel']; ?>"><img src="joimg/artikel/s_<?php echo $ka['gambar']; ?>" alt=""></a>
							</div>
							<?php echo $ka['isi']; ?><br>
							<a class="btn btn-primary" href="detail-artikel-<?php echo $ka['id_artikel']; ?>">Read More</a>
						</div>
						<?php
						}
						$jmldata     = mysql_num_rows(mysql_query("SELECT * FROM artikel WHERE aktif='YA'"));
